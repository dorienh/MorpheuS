...
public class AudioVisualiserDeepModel {
...
////       filename = "./data/Prelude_C_Major_-_Bach.xml";
        ...
        String inputwindow = inputarguments.inputwindow;
        String outputwindow = inputarguments.outputwindow;
        String runtype = inputarguments.runtype;
        int runID = inputarguments.run;

        String keylabel = inputarguments.key;
        ...
        featureX pitchmodel = new featureX(true, inputwindow, outputwindow, true, true, keylabel, runtype, runID);
        //pitchmodel.calctTM();
        //pitchmodel.writeTM();
...
//
        ...
        pitchmodel.calculateTensionReduced();
